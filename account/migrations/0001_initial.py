    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clearance_level', models.IntegerField(default=-1, help_text='The clearance level of the user for all organizations.', validators=[django.core.validators.MinValueValidator(-1), django.core.validators.MaxValueValidator(4)])),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(models.F('user'), django.db.models.functions.text.Lower('name'), name='unique name')],
            },
        ),
    ]

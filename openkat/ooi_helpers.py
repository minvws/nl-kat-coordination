...
def get_or_create_ooi(
    api_connector: OctopoesAPIConnector, ooi: OOI, observed_at: datetime, end_valid_time: datetime | None = None
) -> tuple[OOI, bool]:
    try:
        return api_connector.get(ooi.reference, observed_at), False
    except ObjectNotFoundException:
        create_ooi(api_connector, ooi, observed_at, end_valid_time)
        return ooi, True
...
def create_oois(
    api_connector: OctopoesAPIConnector, oois: list[OOI], observed_at: datetime, end_valid_time: datetime | None = None
) -> None:

...
from openkat.forms.base import BaseOpenKATForm, DataListInput, DateTimeInput
from openkat.forms.settings import RAW_FILE_DATETIME_HELP_TEXT


class UploadRawForm(BaseOpenKATForm):
    type = forms.CharField(
        label=_("File Type"), required=True, widget=forms.TextInput(attrs={"placeholder": "text/html, image/jpeg, ..."})
    )

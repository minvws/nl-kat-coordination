...
from openkat.forms.settings import OBSERVED_AT_HELP_TEXT, Choices, ChoicesGroups


class BaseOpenKATModelForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.label_suffix = ""  # Removes : as label suffix


class BaseOpenKATForm(forms.Form):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.label_suffix = ""  # Removes : as label suffix
...
class ObservedAtForm(BaseOpenKATForm):

...
from openkat.forms.base import BaseOpenKATForm, CheckboxGroup
from openkat.forms.settings import CLEARANCE_TYPE_CHOICES


class OOIForm(BaseOpenKATForm):
...
class ClearanceFilterForm(BaseOpenKATForm):
...
class OOITypeMultiCheckboxForm(BaseOpenKATForm):

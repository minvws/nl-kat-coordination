...
from openkat.ooi_helpers import OOI_TYPES_WITHOUT_FINDINGS
from openkat.view_helpers import existing_ooi_type
from openkat.views.ooi_view import BaseOOIFormView

EXCLUDE_OOI_TYPES = [
    ooi_type.get_object_type()
    for ooi_type in [RESTAPI, Incident, ImageMetadata, Report, ReportData, BaseReport, AssetReport, HydratedReport]
]

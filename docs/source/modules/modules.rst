...
The overarching concept of OpenKAT is explained in the section :ref:`How does OpenKAT work?`. The explanation centers around the image below. All modules of OpenKAT can be found there, except for our web interface and styling modules Rocky and Manon.

...
OpenKAT consists of separate modules that each perform a specific task. All modules are located in the `NL-KAT-Coordination <https://github.com/minvws/nl-kat-coordination>`_ repository. The 'Modules of OpenKAT' section of the documentation goes into detail on each of these modules.

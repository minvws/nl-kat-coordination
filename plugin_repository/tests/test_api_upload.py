...
from plugin_repository.tests.common import load_plugin, upload_plugin

TEMP_PLUGINS_DIR = Path(tempfile.mkdtemp())


@patch("plugin_repository.utils.index.PLUGINS_DIR", TEMP_PLUGINS_DIR)
class TestUploadAPI(TestCase):
    ...
    @patch("plugin_repository.api.routers.plugins.PLUGINS_DIR", TEMP_PLUGINS_DIR)

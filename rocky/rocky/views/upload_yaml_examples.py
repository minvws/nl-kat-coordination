...
network_1 = {"ooi_type": "Network", "clearence": 2, "name": "localhost"}
...
ip_address_2 = {"ooi_type": "IPAddress", "clearance": 2, "address": "127.0.0.1", "network": network_1}

ip_address_v4_1 = {"ooi_type": "IPAddressV4", "clearance": 2, "address": "127.0.0.1", "network": network_1}
...
hostname_1 = {"ooi_type": "Hostname", "clearance": 2, "name": "localhost", "network": network_1}

service_1 = {"ooi_type": "Service", "clearance": 2, "name": "name_of_Service"}

ip_service_1 = {"ooi_type": "IPService", "clearance": 2, "ip_port": ip_port_1, "service": service_1}

website_1 = {"ooi_type": "Website", "clearance": 2, "ip_service": ip_service_1, "hostname": hostname_1}
...
http_resource_1 = {"ooi_type": "HTTPResource", "clearance": 2, "website": website_1, "web_url": hostname_http_url_1}
http_header_1 = {
    "ooi_type": "HTTPHeader",
    "clearance": 2,
...
url_1 = {"ooi_type": "URL", "clearance": 2, "network": network_1, "raw": "https://example.com"}

restapi_1 = {"ooi_type": "RESTAPI", "clearance": 2, "api_url": ip_address_http_url_1}

api_design_rule_1 = {"ooi_type": "APIDesignRule", "clearance": 2, "name": "APIDesignRuleName"}
...
application_1 = {"ooi_type": "Application", "clearance": 2, "name": "name_of_Application"}


cwe_finding_type_1 = {"ooi_type": "CWEFindingType", "clearance": 2, "id": "id_of_CWEFindingType"}
finding_1 = {
    "ooi_type": "Finding",
...
net_block_1 = {"ooi_type": "NetBlock", "clearance": 2, "network": network_1, "start_ip": ip_address_v4_1, "mask": 16}
net_block_2 = {"ooi_type": "NetBlock", "clearance": 2, "network": network_1, "start_ip": ip_address_v6_1, "mask": 16}

dns_zone_1 = {"ooi_type": "DNSZone", "clearance": 2, "hostname": hostname_1}
...
http_header_url_1 = {"ooi_type": "HTTPHeaderURL", "clearance": 2, "header": http_header_1, "url": url_1}
...
security_txt_1 = {"ooi_type": "SecurityTXT", "clearance": 2, "website": website_1, "url": url_1}

software_instance_1 = {"ooi_type": "SoftwareInstance", "clearance": 2, "ooi": network_1, "software": software_1}

external_scan_1 = {"ooi_type": "ExternalScan", "clearance": 2, "name": "name_of_ExternalScan"}
...
geographic_point_1 = {"ooi_type": "GeographicPoint", "clearance": 2, "ooi": network_1, "longitude": 10, "latitude": 10}
...
adr_finding_type_1 = {"ooi_type": "ADRFindingType", "clearance": 2, "id": "id_of_ADRFindingType"}
cve_finding_type_1 = {"ooi_type": "CVEFindingType", "clearance": 2, "id": "id_of_CVEFindingType"}
capec_finding_type_1 = {"ooi_type": "CAPECFindingType", "clearance": 2, "id": "id_of_CAPECFindingType"}
retire_js_finding_type_1 = {"ooi_type": "RetireJSFindingType", "clearance": 2, "id": "id_of_RetireJSFindingType"}
snyk_finding_type_1 = {"ooi_type": "SnykFindingType", "clearance": 2, "id": "id_of_SnykFindingType"}
kat_finding_type_1 = {"ooi_type": "KATFindingType", "clearance": 2, "id": "id_of_KATFindingType"}
muted_finding_1 = {
...
nx_domain_1 = {"ooi_type": "NXDOMAIN", "clearance": 2, "hostname": hostname_1}
...
dkim_exists_1 = {"ooi_type": "DKIMExists", "clearance": 2, "hostname": hostname_1}
dkim_key_1 = {"ooi_type": "DKIMKey", "clearance": 2, "key": "key_at_DKIMKey", "dkim_selector": dkim_selector_1}

config_1 = {"ooi_type": "Config", "clearance": 2, "ooi": network_1, "bit_id": "bit_id_at_Config", "config": {}}

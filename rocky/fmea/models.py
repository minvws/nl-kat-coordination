...
class FailureModeEffect(models.Model):
    ...
    severity_level = models.PositiveSmallIntegerField(choices=BLANK_CHOICE + SEVERITY_LEVEL.choices, blank=False)
...
class FailureMode(models.Model):
    ...
    frequency_level = models.PositiveSmallIntegerField(choices=BLANK_CHOICE + FREQUENCY_LEVEL.choices)
    detectability_level = models.PositiveSmallIntegerField(choices=BLANK_CHOICE + DETECTABILITY_LEVEL.choices)
...
class FailureModeAffectedObject(models.Model):
    ...
    affected_department = models.CharField(max_length=50, choices=BLANK_CHOICE + DEPARTMENTS.choices)

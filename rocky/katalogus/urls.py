...
from katalogus.views.nibbles import NibblesRegisterView, NibblesToggleView, NibblesView
...
urlpatterns = [
    ...
    path("plugins/nibbles/register/", NibblesRegisterView.as_view(), name="nibbles_register"),

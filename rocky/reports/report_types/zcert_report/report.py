...
class ZCERTReport(Report):
    id = "zcert-report"
    name = _("ZCERT Report")
    description = _("ZCERT reports focus on domain name system configuration and potential weaknesses.")
    plugins = {"required": ["dns-records", "dns-sec"], "optional": ["dns-zone"]}
    input_ooi_types = {Hostname}
    template_path = "zcert_report/report.html"

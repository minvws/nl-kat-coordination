...
class Scheduler(abc.ABC):
    ...
    def push_tasks_to_queue(self, tasks: list[models.Task]) -> None:
    ...
    def push_task_to_queue_with_timeout(
        self,
        task: models.Task,
        max_tries: int = 5,
        timeout: int = 1,
        ...
        self.push_task_to_queue(task)

    def push_task_to_queue(self, task: models.Task) -> None:

...
class BoefjeRanker(Ranker):
    ...
    def rank(self, obj: Any) -> int:
        ...
        prior_tasks: Optional[List[models.Task]] = self.ctx.task_store.get_tasks_by_hash(obj.hash)
        ...
        for prior_task in prior_tasks:
            ...
            # TODO: what do we do on exceptions?
        ...
        # TODO
        if not freq_duration or not freq_objects or not freq_findings or not freq_priorities:
            return -1

...
class BoefjeSchedulerTestCase(BoefjeSchedulerBaseTestCase):
    ...
    def test_is_task_not_running(self):
        ...
        # Act
        is_running = self.scheduler.is_task_running(boefje_task)
    ...
    def test_is_task_running_stalled_before_grace_period(self):
        ...
        # Act
        self.assertFalse(self.scheduler.is_task_stalled(boefje_task))
    ...
    def test_is_task_running_stalled_after_grace_period(self):
        ...
        # Act
        self.assertTrue(self.scheduler.is_task_stalled(boefje_task))
    ...
    def test_is_task_running_mismatch_before_grace_period(self):
        ...
        with self.assertRaises(RuntimeError):
            self.scheduler.is_task_running(boefje_task)
    ...
    def test_is_task_running_mismatch_after_grace_period(self):
        ...
        # Act
        self.assertFalse(self.scheduler.is_task_running(boefje_task))
...
class RescheduleTestCase(BoefjeSchedulerBaseTestCase):
    def setUp(self):
        ...
        self.mock_get_schemas = mock.patch(
            "scheduler.context.AppContext.datastores.schema_store.get_schemas",
        ).start()
    ...
    def test_push_tasks_for_rescheduling(self):
        ...
        self.assertEqual(schema.hash, peek.hash)
    ...
    def test_push_tasks_for_rescheduling_no_ooi(self):
        ...
        # Assert: new item is created with a similar task
        peek = self.scheduler.queue.peek(0)
        self.assertEqual(schema_db.hash, peek.hash)
    ...
    def test_push_tasks_for_rescheduling_ooi_not_found(self):
        ...
        schema_db_disabled = self.mock_ctx.datastores.schema_store.get_schema(schema.id)
        self.assertFalse(schema_db_disabled.enabled)

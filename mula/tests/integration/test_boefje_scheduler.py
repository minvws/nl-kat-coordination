...
class RescheduleTestCase(BoefjeSchedulerBaseTestCase):
    ...
    def test_push_tasks_for_rescheduling_boefje_not_found(self):
        ...
        self.mock_get_jobs.return_value = ([job], 1)
        self.mock_get_object.return_value = ooi
        self.mock_get_boefje.return_value = None
...
class TestCalculateDeadline(BoefjeSchedulerBaseTestCase):
    ...
    def test_calculate_deadline(self):
        ...
        # Mock
        mock_handle_signal = mock.patch("scheduler.schedulers.BoefjeScheduler.handle_signal_task_updated").start()
        ...
        # Assert
        mock_handle_signal.assert_called()
        self.assertEqual(1, mock_handle_signal.call_count)

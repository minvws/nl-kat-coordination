...
\newcommand\reporttitle{Bevindingenrapport voor DKIMExists DKIM Exists on antagonist.nl}
\newcommand\tlp{AMBER}
...
\begin{longtable}{ p{.25\textwidth}  p{.75\textwidth} }
            ...
            Ooi & Dkimexists|internet|antagonist.nl \\
...
\end{longtable}
    ...
    \noindent Kopieer \href{http://localhost:8000/nl/_rieven/objects/report/?observed_at=2023-11-07&depth=1&ooi_id=DKIMExists%7Cinternet%7Cantagonist.nl}{deze link} om dit rapport te reproduceren.

...
Dit zijn de bevindingen van een OpenKAT-analyse op 2024-08-14 12:08:01 UTC. % chktex 36 chktex 18
De volgende filters zijn van toepassing op deze bevindingen:

\begin{longtable}{ p{.25\textwidth}  p{.75\textwidth} }

            Observed at & 2024{-}08{-}14 \\
...
\end{longtable}
    ...
    \noindent Kopieer \href{http://localhost:8000/nl/_rieven/findings/?observed_at=2024-08-14}{deze link} om dit rapport te reproduceren.
...
\begin{tabular}{ llr }
	...
	\toprule
		...
		\colorbox{box-color-medium}{ \color{color-medium} medium } & 2 & 4 \\

		\colorbox{box-color-low}{ \color{color-low} low } & 2 & 2 \\
...
\begin{tabular}{ llr }
	...
	\midrule
		...
		\colorbox{box-color-medium}{ \color{color-medium} medium } & KAT-NO-DNSSEC & 3 \\

		\colorbox{box-color-low}{ \color{color-low} low } & KAT-NO-CAA & 1 \\

		\colorbox{box-color-low}{ \color{color-low} low } & KAT-WEBSERVER-NO-IPV6 & 1 \\
...
\chapter{Bevindingen}
	...
	\begin{longtable}{ p{.25\textwidth}  p{.75\textwidth} }
		...
		Ernst & Medium \\
		  ...
		  Beschrijving & This hostname does not have a DMARC record. \\
			...
			Bron& \href{https://www.cloudflare.com/en{-}gb/learning/dns/dns{-}records/dns{-}dmarc{-}record/}{https://www.cloudflare.com/en{-}gb/learning/dns/dns{-}records/dns{-}dmarc{-}record/} \\
	...
	\begin{longtable}{ p{.25\textwidth}  p{.75\textwidth} }
		...
		Ernst & Medium \\
		  ...
		  Beschrijving & The provided domain does not have DNSSEC enabled. \\
			...
			Bron& \href{https://www.dns{-}school.org/Documentation/dnssec\_howto.pdf}{https://www.dns{-}school.org/Documentation/dnssec\_howto.pdf} \\
	...
	\subsection{Bevinding informatie}
	\begin{longtable}{ p{.25\textwidth}  p{.75\textwidth} }
		Bevinding & KAT{-}NO{-}CAA \\
		Risico niveau & 3.9 / 10 \\

		Ernst & Low \\

		  Beschrijving & This zone does not carry at least one CAA record. \\



			Aanbeveling & Set a CAA record to limit which CA's are allowed to issue certs. \\


			Bron& \href{https://letsencrypt.org/docs/caa/}{https://letsencrypt.org/docs/caa/} \\
	...
	\subsection{Voorvallen}
		...
		\subsubsection{\humanreadable{Hostname|internet|rieven.com}}
		This hostname does not have a CAA record
	...
	\begin{longtable}{ p{.25\textwidth}  p{.75\textwidth} }
		...
		Ernst & Low \\
		  ...
		  Beschrijving & For this website there is no web server with an IPv6 address available. \\
			...
			Bron& \href{https://www.internetsociety.org/deploy360/ipv6/}{https://www.internetsociety.org/deploy360/ipv6/} \\
	...
	\begin{longtable}{ p{.25\textwidth}  p{.75\textwidth} }
		...
		Ernst & Recommendation \\
		  ...
		  Beschrijving & This nameserver does not have an IPv6 address. \\
			...
			Aanbeveling & Ensure that the nameserver has an IPv6 address that can be reached. \\


			Bron& \href{https://www.rfc{-}editor.org/rfc/rfc3901.txt}{https://www.rfc{-}editor.org/rfc/rfc3901.txt} \\

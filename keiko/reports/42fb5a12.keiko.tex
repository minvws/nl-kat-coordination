...
\newcommand\reporttitle{Bevindingenrapport voor URL https://rieven.com @internet}
\newcommand\tlp{AMBER}
...
Dit zijn de bevindingen van een OpenKAT-analyse op 2023-09-18 23:09:59 UTC. % chktex 36 chktex 18
De volgende filters zijn van toepassing op deze bevindingen:

\begin{longtable}{ p{.25\textwidth}  p{.75\textwidth} }

            Observed at & 2023{-}09{-}18 \\

            Ooi & Url|internet|https://rieven.com \\
...
\end{longtable}
    ...
    \noindent Kopieer \href{http://localhost:8000/nl/_rieven/objects/report/?observed_at=2023-09-18&depth=9&ooi_id=URL%7Cinternet%7Chttps%3A%2F%2Frieven.com}{deze link} om dit rapport te reproduceren.

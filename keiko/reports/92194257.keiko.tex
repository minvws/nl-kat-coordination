...
Dit zijn de bevindingen van een OpenKAT-analyse op 2023-09-05 12:09:13 UTC. % chktex 36 chktex 18
...
\begin{tabular}{ llr }
	...
	\midrule
		...
		\colorbox{box-color-medium}{ \color{color-medium} medium } & KAT-NO-DNSSEC & 16 \\

		\colorbox{box-color-low}{ \color{color-low} low } & KAT-WEBSERVER-NO-IPV6 & 10 \\

		\colorbox{box-color-recommendation}{ \color{color-recommendation} recommendation } & KAT-NAMESERVER-NO-IPV6 & 2 \\
...
\chapter{Bevindingen}
	...
	\subsection{Voorvallen}
		...
		\subsubsection{\humanreadable{Hostname|internet|academy.ngrane.com}}
		Domain academy.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|base.ngrane.com}}
		Domain base.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|blog.ngrane.com}}
		Domain blog.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|content.ngrane.com}}
		Domain content.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|ftp.ngrane.com}}
		Domain ftp.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|mail.ngrane.com}}
		Domain mail.ngrane.com is not signed with DNSSEC.
		...
		\subsubsection{\humanreadable{Hostname|internet|ns3.ngrane.com}}
		Domain ns3.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|repo.ngrane.com}}
		Domain repo.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|server.ngrane.com}}
		Domain server.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|support.ngrane.com}}
		Domain support.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|www.blog.ngrane.com}}
		Domain www.blog.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|www.ngrane.com}}
		Domain www.ngrane.com is not signed with DNSSEC.

		\subsubsection{\humanreadable{Hostname|internet|www.support.ngrane.com}}
		Domain www.support.ngrane.com is not signed with DNSSEC.

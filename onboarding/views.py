...
from openkat.ooi_helpers import get_or_create_ooi
from openkat.view_helpers import Breadcrumb
from openkat.views.indemnification_add import IndemnificationAddView
from openkat.views.mixins import SingleOOIMixin, SingleOOITreeMixin
...
class OnboardingSetupScanOOIAddView(
    ...
    def get_or_create_url_object(self, url: str) -> OOI:
        ...
        url_ooi, _ = get_or_create_ooi(self.octopoes_api_connector, url, observed_at)
        return url_ooi

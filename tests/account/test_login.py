...
def test_login_view(rf, clientuser):
    ...
    response = LoginOpenKATView.as_view()(request)
...
def test_login(superuser):
    ...
    response = client.post(
        "/en/login/",
        {
            ...
            "login_open_kat_view-current_step": "auth",
        },
    )
    ...
    response = client.post(
        "/en/login/",
        {"auth-username": "admin@openkat.nl", "auth-password": "Test!!", "login_open_kat_view-current_step": "auth"},
    )
    ...
    response = client.post("/en/login/", {"token-otp_token": "123456", "login_open_kat_view-current_step": "token"})

...
from openkat.views.mixins import ObservedAtMixin
from openkat.views.ooi_list import OOIListView
from tests.conftest import setup_request


def test_observed_at_no_value(mocker):
    mock_mixin_datetime = mocker.patch("openkat.views.mixins.datetime")
...
def test_observed_at_future_date(rf, client_member, octopoes_api_connector):
    ...
    octopoes_api_connector.list.return_value = Paginated[OOIType](count=200, items=[Network(name="testnetwork")] * 150)

...
def test_ooi_edit(rf, client_member, octopoes_api_connector, network):
...
def test_ooi_edit_report_recipe_get(rf, client_member, octopoes_api_connector, report_recipe):
    octopoes_api_connector.get.return_value = report_recipe
...
def test_ooi_edit_report_recipe_post(rf, client_member, octopoes_api_connector, report_recipe, mocker, mock_scheduler):
    octopoes_api_connector.get.return_value = report_recipe
    mocker.patch("openkat.views.ooi_view.create_ooi")
    ooi_id = f"ReportRecipe|{report_recipe.recipe_id}"

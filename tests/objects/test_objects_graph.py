...
from openkat.views.ooi_tree import OOIGraphView
...
def test_ooi_graph(rf, client_member, octopoes_api_connector, tree):
    ...
    octopoes_api_connector.get_tree.assert_has_calls(
        [

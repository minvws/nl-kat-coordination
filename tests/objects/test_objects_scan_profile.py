...
def test_scan_profile(rf, redteam_member, mock_scheduler, octopoes_api_connector, mocker):
...
def test_scan_profile_submit(rf, redteam_member, mock_scheduler, octopoes_api_connector, mocker):
    mocker.patch("account.mixins.OrganizationView.get_katalogus")
    octopoes_api_connector.get_tree.return_value = ReferenceTree.model_validate(TREE_DATA)
...
def test_scan_profile_submit_no_indemnification(rf, redteam_member, mock_scheduler, octopoes_api_connector, mocker):
    mocker.patch("account.mixins.OrganizationView.get_katalogus")
    octopoes_api_connector.get_tree.return_value = ReferenceTree.model_validate(TREE_DATA)
...
def test_scan_profile_no_permissions_acknowledged(rf, redteam_member, mock_scheduler, tree):
...
def test_scan_profile_no_permissions_trusted(rf, redteam_member, mock_scheduler, octopoes_api_connector, mocker):
    octopoes_api_connector.get_tree.return_value = ReferenceTree.model_validate(TREE_DATA)
    mocker.patch("account.mixins.OrganizationView.get_katalogus")
...
def test_scan_profile_reset_view(rf, redteam_member, mock_scheduler, octopoes_api_connector, mocker):
    octopoes_api_connector.get_tree.return_value = ReferenceTree.model_validate(TREE_DATA)
    mocker.patch("account.mixins.OrganizationView.get_katalogus")
...
def test_scan_reset_calls_octopoes(rf, redteam_member, mock_scheduler, octopoes_api_connector, mocker):
    octopoes_api_connector.get_tree.return_value = ReferenceTree.model_validate(TREE_DATA)
    mocker.patch("account.mixins.OrganizationView.get_katalogus")
    ...
    assert octopoes_api_connector.get_tree.call_count == 1
    assert octopoes_api_connector.save_scan_profile.call_count == 1

...
def test_ooi_list(rf, client_member, octopoes_api_connector):
    ...
    assert octopoes_api_connector.list_objects.call_count == 2
    assertContains(response, "testnetwork")


def test_ooi_list_with_clearance_type_filter_and_clearance_level_filter(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
    ...
    list_call_0 = octopoes_api_connector.list_objects.call_args_list[0]
    ...
    list_call_1 = octopoes_api_connector.list_objects.call_args_list[1]
...
def test_ooi_list_search(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
    ...
    list_call_1 = octopoes_api_connector.list_objects.call_args_list[0]
    assert list_call_1.kwargs["search_string"] == "testnetwork"

    assertContains(response, "Showing 2 of 2 objects")


def test_ooi_list_delete_multiple(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
    ...
    assert response.status_code == 200
    assert octopoes_api_connector.list_objects.call_count == 2
    assert octopoes_api_connector.delete_many.call_count == 1


def test_ooi_list_delete_none(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
...
def test_ooi_list_unknown_action(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
...
def test_update_scan_profile_multiple(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
    ...
    assert response.status_code == 200
    assert octopoes_api_connector.save_many_scan_profiles.call_count == 1


def test_update_scan_profile_single(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
...
def test_update_scan_profile_to_inherit(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
...
def test_update_scan_profile_to_inherit_connection_error(rf, client_member, octopoes_api_connector):
    octopoes_api_connector.save_many_scan_profiles.side_effect = ConnectionError
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
...
def test_update_scan_profile_to_inherit_object_not_found(rf, client_member, octopoes_api_connector):
    octopoes_api_connector.save_many_scan_profiles.side_effect = ObjectNotFoundException("nothing found")
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
...
def test_update_scan_profiles_forbidden_acknowledged(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
    ...
    assert response.headers["location"] == f"/en/{client_member.organization.code}/account/"
    assert (
...
def test_update_scan_profiles_forbidden_trusted(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list", kwargs=kwargs)
...
def test_update_scan_profiles_no_indemnification(rf, redteam_member, octopoes_api_connector):
...
def test_update_scan_profiles_octopoes_down(rf, client_member, octopoes_api_connector):
    octopoes_api_connector.save_many_scan_profiles.side_effect = ConnectionError
...
def test_update_scan_profiles_object_not_found(rf, client_member, octopoes_api_connector):
    octopoes_api_connector.save_many_scan_profiles.side_effect = ObjectNotFoundException("gone")
    client_member.trusted_clearance_level = 2
    client_member.acknowledged_clearance_level = 2
    client_member.save()
...
def test_delete_octopoes_down(rf, client_member, octopoes_api_connector):
    octopoes_api_connector.delete_many.side_effect = ConnectionError
...
def test_delete_object_not_found(rf, client_member, octopoes_api_connector):
    octopoes_api_connector.delete_many.side_effect = ObjectNotFoundException("gone")
...
def test_ooi_list_export_json(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    ...
    assert octopoes_api_connector.list_objects.call_count == 1
...
def test_ooi_list_export_csv(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list_export", kwargs=kwargs)
...
def test_ooi_list_filtered_export_csv(rf, client_member, octopoes_api_connector):
    kwargs = {"organization_code": client_member.organization.code}
    url = reverse("ooi_list_export", kwargs=kwargs)
    request = rf.get(
    ...
    mock_calls = octopoes_api_connector.list_objects.mock_calls
...
def test_delete_perms_object_list(request, member, rf, octopoes_api_connector):
...
def test_delete_perms_object_list_clients(rf, client_member, octopoes_api_connector):
    octopoes_api_connector.list_objects.return_value = Paginated[OOIType](
        count=200, items=[Network(name="testnetwork")] * 150
    )

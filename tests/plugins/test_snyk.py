...
from katalogus.boefjes.kat_snyk.main import run as run_boefje
from katalogus.boefjes.kat_snyk.normalize import run
...
def test_snyk_html_parser(mocker):
    mock_get = mocker.patch("katalogus.boefjes.kat_snyk.main.requests.get")

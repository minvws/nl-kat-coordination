...
from openkat.forms.base import BaseOpenKATForm, DateInput
from reports.report_types.definitions import Report


class OOITypeMultiCheckboxForReportForm(BaseOpenKATForm):
...
class ReportTypeMultiselectForm(BaseOpenKATForm):
...
class ReportScheduleStartDateChoiceForm(BaseOpenKATForm):
...
class ReportRecurrenceChoiceForm(BaseOpenKATForm):
...
class ReportScheduleStartDateForm(BaseOpenKATForm):
...
class CustomReportScheduleForm(BaseOpenKATForm):
    start_date = forms.DateField(
        label=_("Start date"),
        widget=DateInput(format="%Y-%m-%d"),
        initial=lambda: datetime.now(tz=timezone.utc).date(),
...
class ReportNameForm(BaseOpenKATForm):

...
from openkat.views.health import flatten_health, get_openkat_health
...
class AggregateOrganisationReport(AggregateReport):
    ...
    def post_process_data(
        ...
        flattened_health = flatten_health(get_openkat_health(organization_code, self.octopoes_api_connector))

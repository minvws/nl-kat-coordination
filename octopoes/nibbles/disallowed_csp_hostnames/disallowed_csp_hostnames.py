...
def nibble(input_ooi: HTTPHeaderHostname, config: Config | None) -> Iterator[OOI]:
    ...
    disallow_url_shorteners = config.config.get("disallow_url_shorteners", True) if config and config.config else True

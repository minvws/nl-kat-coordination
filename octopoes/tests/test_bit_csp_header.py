...
def test_check_csp_headers(http_resource_https):
    headers_to_test = [
        ...
        ("content-security-policy", "default-src https://a.com; ...; media-src 'self'; media-src 10.10.10.10;"),
 ...
 9. CSP setting has no value."""
    ...
    assert results[7][0].id == "KAT-CSP-VULNERABILITIES"
    assert (
        results[7][1].description
        == """List of CSP findings:

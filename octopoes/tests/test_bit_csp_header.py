...
def test_https_hsts(http_resource_https):
    results = [list(run(HTTPHeader(resource=http_resource_https.reference, key=key, value=value), [], {}))
        for key, value in [
    ...
    assert results[1][1].description == """List of CSP findings:
 ...
 6. CSP setting has no value."""
    ...
    assert results[2][1].description == """List of CSP findings:
 ...
 7. CSP setting has no value."""
    ...
    assert results[3][1].description == """List of CSP findings:
 1. frame-src has not been defined or does not have a fallback.
 2. script-src has not been defined or does not have a fallback.
 3. base-uri has not been defined, default-src does not apply.
 4. frame-ancestors has not been defined.
 ...
 6. CSP setting has no value."""
    ...
    assert results[4][1].description == """List of CSP findings:
 ...
 7. CSP setting has no value."""
    ...
    assert results[5][1].description == """List of CSP findings:
 1. frame-src has not been defined or does not have a fallback.
 2. script-src has not been defined or does not have a fallback.
 3. base-uri has not been defined, default-src does not apply.
 4. frame-ancestors has not been defined.
 ...
 9. CSP setting has no value."""
    ...
    assert results[6][1].description == """List of CSP findings:

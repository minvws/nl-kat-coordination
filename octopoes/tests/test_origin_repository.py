...
def test_save_new_task_id_origin(origin_repository, valid_time, mocker):
    old_origin = Origin(origin_type=OriginType.OBSERVATION, method="method", source="source", task_id="task1")
    new_origin = Origin(origin_type=OriginType.OBSERVATION, method="method", source="source", task_id="task2")

...
from boefjes.worker.interfaces import BoefjeInput, BoefjeOutput, StatusEnum, Task, TaskStatus, TaskPop
...
@app.post("/api/v0/scheduler/{queue_id}/pop", response_model=TaskPop | None, tags=["scheduler"])
def pop_tasks(
    queue_id: str,
    limit: int = 1,

...
def downgrade() -> None:
    ...
    op.create_table('setting',
        ...
        sa.ForeignKeyConstraint(['organisation_pk'], ['organisation.pk'], name='setting_organisation_pk_fkey', ondelete='CASCADE'),
    ...
    # Seed the original data into the new table
    conn.execute("INSERT INTO setting (key, value, organisation_pk, plugin_id) SELECT json_data.key as key, json_data.value as value, organisation_pk, plugin_id from settings, json_each_text(settings.values) as json_data;")

...
class SQLPluginStorage(SessionMixin, PluginStorage):
    ...
    def to_boefje_in_db(boefje: Boefje, pk: int | None = None) -> BoefjeInDB:
        ...
        boefje = BoefjeInDB(
            ...
            rate_limit_interval=boefje.rate_limit_interval,
            rate_limit_group=boefje.rate_limit_group,
    ...
    def to_boefje(boefje_in_db: BoefjeInDB) -> Boefje:
        return Boefje(
            ...
            rate_limit_interval=boefje_in_db.rate_limit_interval,
            rate_limit_group=boefje_in_db.rate_limit_group,

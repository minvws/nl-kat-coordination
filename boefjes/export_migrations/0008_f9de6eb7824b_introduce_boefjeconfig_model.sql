...
INSERT INTO normalizer (
  ...
  static
    ...
    ('kat_dnssec_normalize', 'DNS records', 'Parses DNSSEC data into findings.', '{"boefje/dns-sec", "openkat/dnssec-output", "normalizer/kat_dnssec_normalize"}', '{"KATFindingType", "Finding"}', '{"TEST_KEY"}', null, true),

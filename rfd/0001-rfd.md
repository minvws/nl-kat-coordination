...
2.  Create branch for your RFD
    ...
    name should be in the format `rfd/{number}-{title}`. If less than 4 digits,
    ...
    ```bash
    # git checkout -b rfd/{number}-{title}
    git checkout -b rfd/0042-question-of-life
    ```
...
5.  Push your RFD branch remotely:
    ...
    git push origin rfd/0042-question-of-life
    ```
...
6.  Work on your RFD branch.
    ...
    ```bash
    git checkout rfd/0042-question-of-life
    ```

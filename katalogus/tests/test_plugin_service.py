...
from katalogus.clients import MockPluginRepositoryClient
from katalogus.dependencies.plugins import PluginService
from katalogus.local_repository import LocalPluginRepository
from katalogus.models import Boefje, Normalizer, Bit, Repository
...
def mock_plugin_service(organisation_id: str) -> PluginService:
    ...
    sys.path.append(str(test_boefjes_dir.parent))

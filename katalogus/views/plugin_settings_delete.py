...
from katalogus.views.mixins import SingleBoefjeView

logger = structlog.get_logger(__name__)


class PluginSettingsDeleteView(OrganizationPermissionRequiredMixin, SingleBoefjeView, TemplateView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        except BoefjeConfig.DoesNotExist:
            messages.add_message(request, messages.WARNING, _("Plugin {} has no settings.").format(self.plugin.name))

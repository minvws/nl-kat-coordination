...
def upgrade() -> None:
    ...
    op.create_index("boefje_meta_organization_boefje_id", "boefje_meta", ["organization", "boefje_id"], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("boefje_meta_organization_boefje_id", table_name="boefje_meta")
    # ### end Alembic commands ###
